...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_chat_chat__ = __webpack_require__(95);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_create_document_create_document__ = __webpack_require__(164);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_my_document_my_document__ = __webpack_require__(383);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_downloaddocument_downloaddocument__ = __webpack_require__(165);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_ng_socket_io__ = __webpack_require__(40);
...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, navParams, documentProvider, userProvider, chatProvider, alertCtrl, app, socket) {
        var _this = this;
                    ...
                    handler: function (data) {
                        ...
                        _this.documentProvider.verificationDocument(target).subscribe(function (result) {
                            ...
                            if (result) {
                                ...
                                _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_9__pages_downloaddocument_downloaddocument__["a" /* DownloaddocumentPage */]);
                            }
                            else {
                    ...
                    handler: function (data) {
                        ...
                        _this.documentProvider.verificationDocument(target).subscribe(function (result) {
                            if (result) {
                                ...
                                _this.nav.push(__WEBPACK_IMPORTED_MODULE_5__pages_edit_edit__["a" /* EditPage */]);
                            }
                            else {
